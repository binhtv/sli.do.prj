...
class Comment extends Component {
  ...
  onLike() {
    ...
    liked^=true;
    if(liked) {
      localStorage.setItem('likes', JSON.stringify([...likes, this.props.data.id]));
    } else {
      localStorage.setItem('likes', JSON.stringify(likes.filter(like => like != this.props.data.id)));
    }
      ...
      <div className={"list-group-item comment-item " + extraClass}>
        <div className="comment-info">
          ...
          <div className="action">
            ...
            <a href="javascript:void(0);" onClick={(e) => this.onLike()}>
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={"icon ui-f-grey-2 icon-size14 " + liked}>
                <title>like-o</title>
